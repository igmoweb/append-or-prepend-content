...
class Test_Append_Or_Prepend_Single extends AppOrPrependTestCase {
	 ...
	 * Single: ON
	 */
	function test_content_is_appended_in_single() {
	 ...
	 * Single: ON
	 */
	function test_content_is_appended_in_single_2() {
	 ...
	 * Single: OFF
	 */
	function test_content_is_NOT_appended_in_single() {
		update_option( 'display_in_archive_post', 1 );
	 ...
	 * Single: OFF
	 */
	function test_content_is_NOT_appended_in_single_2() {
		update_option( 'display_in_archive_post', 0 );
		update_option( 'display_in_single_post', 0 );
		$this->assertNotContains( $this->content_appended, apply_filters( 'the_content', '' ) );
	}
